const recipes = [
  ...
  },
  {
    ...
    recipeIngredient: [
      ...
      '2 tsp Chicken Bouillion', '3/4 C Sour Cream', '1-2 C Chicken, cubed', '2 C Rice, uncooked'
    ],
    name: 'Chicken Curry',
    prepTime: '10 min',
    recipeInstructions: [
  ...
  },
  {
    ...
    recipeIngredient: [
      ...
      'For the struesel (crumble):', '250 g (2 cups + 1 tablespoon/ 8.8 oz) plain flour (all purpose flour)',
    ...
    prepTime: '30 min',
    recipeInstructions: [
      'Combine the flour, butter, sugar and eggs in a bowl and beat with a whisk until you have a smooth dough. Transfer the batter to a 26 cm(10 inch) spring-form lined with parchment paper. Smooth with a spoon or spatula and set aside.',
      "Combine sugar, butter and flour for the crumble. Mix with hands until small crumbles form. Set aside. Preheat the oven to 180°C (356°F).",
      'Combine milk, sugar and cornstarch in a small pot. Stir constantly until it bubbles and thickens. Let cool 2-3 minutes. Scatter gooseberries over the base. Add sour cream to cream, whisk, and spread over gooseberries. Sprinkle crumble evenly over top. Bake 45 minutes or until crumbles are lightly golden. Cool slightly and serve with whipped cream.'
    ],
  ...
  },
  {
    ...
    recipeIngredient: [
      ...
      '1 C Brown sugar', '1/4 tsp baking powder', '1/4 tsp baking soda', '1/2 C butter, melted'
    ],
    name: 'Apple Crisp',
    prepTime: '30 min',
    recipeInstructions: [
...
function buildCard(recipe) {
  const tagsHtml = recipe.tags
    .map(t => `<span class="recipe-tag">${t}</span>`)
    .join('');
